// Copyright belongs to: https://github.com/OscarAbraham/UITKEditorAid/blob/master/Editor/PropertyContainer.cs
using UnityEngine;
using UnityEditor;
...
public class PropertyContainer : VisualElement
{
    ...
    private void CheckPrefabOverride()
    {
        ...
        if (proxyHasPropertyOverride != m_HasPropertyOverride)
        {
            ...
            EnableInClassList(BindingExtensions.prefabOverrideUssClassName, proxyHasPropertyOverride);
