...
public abstract partial class MonoBehaviourEvent<T0> : MonoBehaviourEventBase
{
	[Header("MonoBehaviourEvent<T0> Event")]
	#region MonoBehaviourEvent<T0> Event
...
public abstract partial class MonoBehaviourEvent<T0>
{ }
