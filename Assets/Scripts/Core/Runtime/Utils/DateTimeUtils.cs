...
public static class DateTimeUtils
{
	...
	/// <summary> 1 hour = 15 degree </summary>
	public const float ExactHourDegree = (360f / 24f);

	/// <summary> 1 min = 0,25 degree </summary>
	public const float ExactMinutePoint = (ExactHourDegree / 60f);

	/// <summary> 1 second = 0,004166 degree </summary>
	public const float ExactSecondPoint = (ExactMinutePoint / 60f);
