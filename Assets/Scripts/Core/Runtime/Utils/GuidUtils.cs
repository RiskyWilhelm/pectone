...
{
	/// <summary> Reconstructs a <see cref="Guid"/> from two <see cref="ulong"/> values representing the low and high bytes. </summary>
	/// <remarks>
	/// Use <see cref="GuidExtensions.Decompose(Guid, out ulong, out ulong)"/> to separate the Guid into its low and high components.
	/// </remarks>
